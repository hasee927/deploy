...
import { postCurrentUserResetPassword, getGoogleQr } from '@/api/vadmin/auth/user'
...
<template>
  <div class="main-container">
    <div class="form-container">
      <div>
        <h2 class="text-2xl font-bold text-center w-[100%]">1，第一次登录系统，需先重置密码</h2>
      </div>
      <Form
	  ...
	  <div>
	    <h2 class="text-2xl font-bold text-center w-[100%]">2，扫描二维码，添加谷歌验证</h2>
	  </div>
