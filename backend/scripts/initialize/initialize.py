...
from apps.bank.iob import models as iob_models
...
class InitializeData:
    ...
    async def generate_bank_iob(self):
        """
        生成常见问题详情数据
        """
        await self.__generate_data("bank_iob", iob_models.Bank_iob)
