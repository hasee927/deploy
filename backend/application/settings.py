...
# 平台密钥
SYSTEM_KEY = "ts8bkpopplr3sd63cavu14rsvr5ompzq"

#创建表使用
# CREATE_TABLE_DATABASE_URL = "mysql+pymysql://root:7awjer983u4sy#908@127.0.0.1:3306/kinit"
# CREATE_TABLE_DATABASE_URL = "mysql+pymysql://yinggao:7awjer983u4sy#908@192.168.1.198:3306/kinit"
# CREATE_TABLE_DATABASE_URL = "mysql+pymysql://yinggao:7awjer983u4sy#908@192.168.1.247:3306/kinit"
CREATE_TABLE_DATABASE_URL = "mysql+pymysql://yinggao:7awjer983u4sy#908@13.201.23.237:3306/kinit"

#收银台页面地址
CashierAddr = "https://cashier.ygroupcorp.click/?id="
#收银台超时时间(单位秒)
CashierTimeOut = 900

PayAddr = "http://127.0.0.1:8060"